...
if __name__ == "__main__":
    ...
    test_url = "https://bits.logic.inc/p/ai-is-forcing-us-to-write-good-code"
    max_depth = 1
    max_links = 1
    ...
    request = run_local_application(crawl, {"url": test_url, "max_depth": max_depth, "max_links": 1})
    ...
    # Save full crawl output to JSON
    with open("crawler_output.json", "w", encoding="utf-8") as f:
        json.dump(result, f, indent=2, ensure_ascii=False)
        print("\nSaved crawl output to crawler_output.json")

# ---- EXTRACT CLEAN TEXT FROM SCRAPED JSON ----

print("Extracting clean text from crawler_output.json...")
...
print("Clean text saved to clean_text.txt")
